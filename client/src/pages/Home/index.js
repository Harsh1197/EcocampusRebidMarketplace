        ...
        <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-5 w-full">
                <div className="flex items-center gap-5">
                    ...
                    <SearchInput class="custom-search-input typing-effect" placeholder="What are you looking for" />
                        ...
                        >
                            ...
                            <div className="p-2 mt-2 space-y-2">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <button
                                        className="text-white font-bold py-2 px-4 rounded border border-gray-300 cursor-pointer" style={{ background: "#191e29" }}
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            showModal(product);
                                        }}
